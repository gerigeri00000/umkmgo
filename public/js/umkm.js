...
const kategoriChart = new Chart(document.getElementById('kategoriChart'), {
        ...
        options: {
            ...
            plugins: {
                ...
                title: { display: true, text: 'Jumlah UMKM per Kategori' }
            },
            scales: {
...
// Pie Chart Kecamatan
const kecamatanChart = new Chart(document.getElementById('kecamatanChart'), {
        type: 'bar',
        data: {
            labels: kecamatanData.map(item => item.kecamatan),
            datasets: [{
                label: 'Jumlah UMKM',
                data: kecamatanData.map(item => item.count),
        ...
        options: {
            ...
            plugins: {
                legend: { display: false },
                title: { display: true, text: 'Jumlah UMKM per Kecamatan' }
            },
            scales: {
                x: { ticks: { autoSkip: false, maxRotation: 90, minRotation: 45 }},
                y: { beginAtZero: true }
